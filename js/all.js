...
/* ---- data/1Gfey7wVXXg1rxk751TBTxLJwhddDNfcdp/js/ZeroBoard.coffee ---- */
...
(function() {
  ...
  ZeroBoard = (function(_super) {
    ...
    ZeroBoard.prototype.submittedMessage = function(ret, status, error) {
      this.log("Message submitted", ret, status, error);
      ...
      if (status === "success") {
        ...
        return this.cmd("wrapperNotification", ["error", "Message submit failed!<br>" + ret.responseText]);
      }
    };
    ...
    ZeroBoard.prototype.updateSite = function() {
    ...
    ZeroBoard.prototype.route = function(cmd, message) {
      if (cmd === "setSiteInfo") {
    ...
    ZeroBoard.prototype.actionSetSiteInfo = function(message) {
      var _ref, _ref1;
      this.log("setSiteinfo", message);
      if (((_ref = message.params.event) != null ? _ref["0"] : void 0) === "file_done" && ((_ref1 = message.params.event) != null ? _ref1["1"] : void 0) === "messages.json") {
